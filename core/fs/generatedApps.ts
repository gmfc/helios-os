...
export const BUGREPORT_MANIFEST = JSON.stringify({
    "name": "bugreport",
    "syscalls": [
        "open",
        "read",
...
export const TUTORIAL_MANIFEST = JSON.stringify({
    "name": "tutorial",
    "syscalls": [
        "write"
    ]
